// ============================================================================
// SYSTÈME D'AUTHENTIFICATION AMÉLIORÉ - Sans mode démo
// ============================================================================
...
export const Login = () => {
  ...
  // Récupérer le plan sélectionné depuis la page pricing (si applicable)
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-md w-full space-y-8">
          ...
          {/* Message si plan sélectionné */}
          {selectedPlan && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                <strong>Plan sélectionné :</strong> {selectedPlan}
              </p>
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="text-white max-w-lg">
            <h1 className="text-4xl font-bold mb-6">
              Bienvenue sur CRMPro2x
            </h1>
            <p className="text-xl text-blue-100 mb-8">
              La solution complète pour gérer votre entreprise efficacement
            </p>
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                ...
                <span>CRM puissant et intuitif</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                  ✓
                </div>
                <span>Gestion de projets complète</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                  ✓
                </div>
                <span>Facturation et finance intégrées</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                  ✓
                </div>
                <span>Messagerie et calendrier</span>
              </li>
            </ul>
          </div>
        </div>
